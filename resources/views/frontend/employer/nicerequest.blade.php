...
*******************************************************
*/
$merchantKey      = "TMMkIBlPq1SeFjgHSYeUyt8Uw5EmsD9cB4s0Y51ij1yCnwNU+T0BdACyhvXJnyYd0ILO/3vOUGNfHsdsyiHoqQ==";   // 상점키
$merchantID       = "slink6412m";                           // 상점아이디
$goodsCnt         = "1";                                    // 결제상품개수
...
<body>
<form name="payForm" method="post" action="niceresult">
