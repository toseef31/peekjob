...
require_once __DIR__.'/nicepay/lib/nicepay/web/NicePayWEB.php';
require_once __DIR__.'/nicepay/lib/nicepay/core/Constants.php';
require_once __DIR__.'/nicepay/lib/nicepay/web/NicePayHttpServletRequestWrapper.php';
/*
*******************************************************
* <결제 결과 설정>
...
$nicepayWEB->setParam("NICEPAY_LOG_HOME","/nicepay/log");             // 로그 디렉토리 설정
...
<link rel="stylesheet" type="text/css" href="/nicepay/css/import.css"/>
</head>
<body> 
