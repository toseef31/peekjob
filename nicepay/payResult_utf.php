...
$nicepayWEB->setParam("NICEPAY_LOG_HOME","https://nicepay.outsourcingok.com/nicepay/log");             // 로그 디렉토리 설정
...
<form name="frm" action="https://www.jobcallme.com">
